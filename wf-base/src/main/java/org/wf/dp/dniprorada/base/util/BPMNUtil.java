...
public class BPMNUtil {
	...
	public static List<User> getUsersInfoBelongToProcess(RepositoryService repositoryService, IdentityService identityService, String processDefinitionId, String taskId){
	...
	public static void loadCandidateGroupsFromTasks(RepositoryService repositoryService, ProcessDefinition processDef, Set<String> candidateCroupsToCheck, String taskId) {
		...
		for (FlowElement flowElement: bpmnModel.getMainProcess().getFlowElements()){
			if (flowElement instanceof UserTask) {
				...
				if (userTask.getId().equals(taskId)){
					...
					LOG.info("Checking task " + userTask.getId() + ":" + userTask.getName() + " with task ID:" + taskId);
				}
			}
		}
	}
	
	public static void loadCandidateStarterGroup(RepositoryService repositoryService, ProcessDefinition processDef, Set<String> candidateCroupsToCheck) {
