...
angular.module('app').directive('placeControl', function($timeout) {
  return {
    restrict: 'E',
    templateUrl: 'app/common/components/form/directives/place/placeControl.html',
    require: 'ngModel',
    link: function(scope, element, attrs, modelCtrl) {
      console.log('place-control: ', scope, element, attrs, modelCtrl);
