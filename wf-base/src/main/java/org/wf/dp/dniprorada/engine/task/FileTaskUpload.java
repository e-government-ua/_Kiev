...
public class FileTaskUpload extends AbstractModelTask implements JavaDelegate {
   ...
   private FlowSlotTicketDao oFlowSlotTicketDao;
	...
	/**
	 * –ü–æ–ª—É—á–∏—Ç—å –∏–¥ –ø–æ–ª—è —Å –∫–∞—Å—Ç–æ–º–Ω—ã–º —Ç–∏–ø–æ–º file
	 * @param oFormData
	 * @return
	 */
...
2015-07-05_15:33:11.144 | INFO | org.wf.dp.dniprorada.engine.task.FileTaskUpload- execution.getCurrentActivityName()=œ≥‰Úˇ„Û‚‡ÌÌˇ ‰ÓÍÛÏÂÌÚ≥‚
