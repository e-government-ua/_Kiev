...
angular.module('dashboardJsApp').service('PrintTemplateService', [function() {
  var service = {
...
angular.module('dashboardJsApp').factory('PrintTemplate', function($sce, $q, tasks, PrintTemplateProcessor) {
  ...
  var PrintTemplate = function(task, form) {
    this.task = task;
    this.form = form;
    // FIXME: remove this. the service should not care about print form visibility
    this.showPrintModal = false;
    this.init();
  };

  PrintTemplate.prototype.init = function() {
    console.log('PrintTemplate init, this', this);
