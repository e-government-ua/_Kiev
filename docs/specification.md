...
http://server:port/wf-central/service/services/getDocument - получение документа по ид документа
...
http://server:port/wf-central/service/services/getDocumentContent- получение контента документа по ид документа
...
http://server:port/wf-central/service/services/getDocumentFile - получение документа в виде файла по ид документа
...
**HTTP Metod: GET**
 ...
 http://server:port/wf-central/service/messages/getMessage - получение массива сообщений
