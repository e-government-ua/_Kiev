...
public enum HistoryEventType {
    ...
    SET_DOCUMENT_INTERNAL(2L,
            ...
            "%Назва органу% завантажує %Тип документу% %Назва документу% у Ваш розділ Мої документи"),
    ...
    SET_DOCUMENT_ACCESS_LINK(4L,
            ...
            "Ви надаєте доступ до документу %Тип документу% %Назва документу% іншій людині: %ФИОІм’я того, кому надають доступ% (телефон: %телефон%)"),
