...
public class ActivitiRestServicesController {
    ...
    public @ResponseBody ResponseEntity removeService(@RequestParam(value = "nID") Integer nID,
    ...
    public @ResponseBody ResponseEntity removeServiceData(@RequestParam(value = "nID") Integer nID,
                                     @RequestParam(value = "bRecursive", required = false) Boolean bRecursive) {
        bRecursive = (bRecursive == null) ? false : bRecursive;
        ResponseEntity response;
        if (bRecursive) {
    ...
    public @ResponseBody ResponseEntity removeSubcategory(@RequestParam(value = "nID") Integer nID,
                                     @RequestParam(value = "bRecursive", required = false) Boolean bRecursive) {
        bRecursive = (bRecursive == null) ? false : bRecursive;
        ResponseEntity response;
        if (bRecursive) {
    ...
    public @ResponseBody ResponseEntity removeCategory(@RequestParam(value = "nID") Integer nID,
                                  @RequestParam(value = "bRecursive", required = false) Boolean bRecursive) {
        bRecursive = (bRecursive == null) ? false : bRecursive;
        ResponseEntity response;
        if (bRecursive) {
    ...
    public @ResponseBody ResponseEntity removeServicesTree() {
