...
public abstract class Abstract_MailTaskCustom implements JavaDelegate {
    ...
    private static final String queryParamPattern = "?nID_Subject=%s&sHead=Отзыв&sBody=Отзыв&sData=Название Услуги&sMail= &nID_SubjectMessageType=1&sAccessContract=Request"; //sAccessKey=%s&amp;
    private static final String accessKeyPattern = "&sAccessKey=%s";
